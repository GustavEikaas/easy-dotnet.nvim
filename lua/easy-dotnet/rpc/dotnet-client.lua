...
---@field upgrade_wizard easy-dotnet.RPC.Client.UpgradeWizard
...
function M:new()
  ...
  instance.upgrade_wizard = require("easy-dotnet.rpc.controllers.upgrade-wizard").new(client)
  return instance
end
    ...
    current_solution.get_or_pick_solution(
      function(sln_file)
        M.create_rpc_call({
          ...
          params = {
            request = {
              clientInfo = { name = "EasyDotnet", version = "3.0.0", pid = vim.fn.getpid() },

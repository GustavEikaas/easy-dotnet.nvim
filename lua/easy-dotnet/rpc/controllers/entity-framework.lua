...
---@field migration_list fun(self: easy-dotnet.RPC.Client.EntityFramework, opts?: easy-dotnet.RPC.CallOpts): easy-dotnet.RPC.CallHandle
...
function M:migration_list(opts)
  local helper = require("easy-dotnet.rpc.dotnet-client")
  opts = opts or {}
  return helper.create_rpc_call({
    client = self._client,
    job = nil,
    method = "ef/migrations-list",
    params = {},
    cb = nil,

...
>[!IMPORTANT]
>This plugin has started using [easy-dotnet-server](https://github.com/GustavEikaas/easy-dotnet-server) for more advanced functionality, as a result the server needs updating more frequently. 
